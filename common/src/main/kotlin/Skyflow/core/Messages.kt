...
import Skyflow.SdkInfo
import Skyflow.utils.Utils

// Placeholder baked into the message strings at enum-load time; substituted with the live
// per-product identity from SdkInfo at getMessage() call time (see docs/sdk-split-plan.md).
// Core intentionally does not read any product's BuildConfig directly.
private const val SDK_NAME_VERSION = "__SKYFLOW_SDK_ID__"
