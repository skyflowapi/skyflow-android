...
class GetTests {
    ...
    fun testMissingRecords() {
        ...
        try {
            LegacyUtils.validateGetInputAndOptions(getRecords, GetOptions(), logLevel)
    ...
    fun testTokensAsTruePassedWithRedaction() {
        ...
        try {
            LegacyUtils.validateGetInputAndOptions(getRecords, GetOptions(true), logLevel)
        } catch (exception: Exception) {
            Assert.assertEquals(skyflowError.getErrorMessage(), exception.message)
        }
    }
    ...
    fun testTokensAsFalsePassedWithRedaction() {
        ...
        try {
            LegacyUtils.validateGetInputAndOptions(getRecords, GetOptions(false), logLevel)
        } catch (exception: Exception) {
            Assert.fail(exception.message)
        }
    }
    ...
    fun testConstructRequestBodyForGet() {
        try {
            getRecords.put("records", recordsArray)
            LegacyUtils.validateGetInputAndOptions(getRecords, GetOptions(), logLevel)
            val requestBody = LegacyUtils.constructRequestBodyForGet(getRecords)
