...
/**
 * Legacy (v1 / privacyDB) client. Extends the shared [BaseSkyflowClient] (which provides
 * `configuration`, `elementMap`, and the `container(...)` factories) and adds the v1 client
 * methods and the v1 api client. The FlowVault SDK's `Client` extends the same base but exposes
 * no standalone client methods. See docs/sdk-split-plan.md.
 */
