...
import com.skyflow_android.reveal.client.RevealApiCallback
...
class APIClient (
    ...
    internal fun post(records: String, callback: SkyflowCallback, options: InsertOptions){
        val collectApiCallback = CollectAPICallback(this, records, callback, options)
        this.getAccessToken(collectApiCallback)
    }

    internal fun get(records:MutableList<RevealRequestRecord>, callback : SkyflowCallback){
