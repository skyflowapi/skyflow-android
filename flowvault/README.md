...
3. [**Initializing skyflow-flowvault-android**](#initializing-skyflow-flowvault-android)
...
<repositories>
    <repository>
      <id>github</id>
      <url>https://maven.pkg.github.com/skyflowapi/skyflow-android</url>
    </repository>
</repositories>
...
<dependency>
   ...
   <artifactId>skyflow-flowvault-android-sdk</artifactId>
...
# Initializing skyflow-flowvault-android
----
...
`Note`:
  ...
  - Use `env` option with caution, make sure the env is set to `PROD` when using `skyflow-flowvault-android` in production. 
...
#### [Sample Code](https://github.com/skyflowapi/skyflow-android/blob/main/samples/flowvault/src/main/java/com/Skyflow/CollectActivity.kt)
...
skyflow-flowvault-android provides two types of validations on Collect Elements
...
#### [Sample Code](https://github.com/skyflowapi/skyflow-android/blob/main/samples/flowvault/src/main/java/com/Skyflow/RevealActivity.kt):
```kotlin
...
#### Sample Code:
[CollectActivity.kt](https://github.com/skyflowapi/skyflow-android/blob/main/samples/flowvault/src/main/java/com/Skyflow/CollectActivity.kt)
...
#### Sample Code:
[RevealActivity.kt](https://github.com/skyflowapi/skyflow-android/blob/main/samples/flowvault/src/main/java/com/Skyflow/RevealActivity.kt)
