...
enum class SkyflowErrorCode(val code:Int, var message:String)
{
    ...
    INVALID_RECORD_IDS_TYPE(400, Messages.INVALID_RECORD_IDS_TYPE.message),
    EMPTY_ID(400, Messages.EMPTY_ID.message),
    ...
    MISSING_RECORD_COLUMN_VALUES(400, Messages.MISSING_RECORD_COLUMN_VALUES.message),
    MISSING_RECORD_COLUMN_NAME(400, Messages.MISSING_RECORD_COLUMN_NAME.message),
